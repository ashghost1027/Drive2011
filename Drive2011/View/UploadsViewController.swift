...
class UploadsViewController: UIViewController {
    ...
    private func uploadToDrive(file: LoadFileViewModel) {
        showProgress()
        driveManager.uploadFile("Drive2011", filePath: file.filePath!, MIMEType: file.mimeType, progressHandler: progressHandler) {
    ...
    private func getUsersUploads() {
        ...
        driveManager.listFilesInFolder("Drive2011") { [weak self] fileList, error in
            guard let self = self else { return }
    ...
    private func setupBarButtons() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(image: UIImage(systemName: "plus"), style: .plain, target: self, action: #selector(chooseFileToUpload))
...
extension UploadsViewController: UIDocumentPickerDelegate {
    ...
    func documentPicker(_ controller: UIDocumentPickerViewController, didPickDocumentAt url: URL) {
        ...
        driveManager.uploadFile("Drive2011", filePath: url, MIMEType: mimeType, progressHandler: progressHandler) { [weak self] fileId, error in
